export const translations = {
  en: {
    ...
    chef: {
      ...
      accoladeExcellenceLabel: 'Culinary Excellence',
      accoladeExcellenceValue: '15+ Years',
      accoladeDishesLabel: 'Dishes Crafted',
      accoladeDishesValue: '200+',
      accoladeGuestsLabel: 'Happy Guests',
      accoladeGuestsValue: '50,000+',
    ...
    chef: {
      ...
      bio1:
        'Kokki Mehmet Yilmaz tuo yli viidentoista vuoden kulinaarisen taidon jokaiseen LIORAn keittiöstä lähtevään annokseen. Istanbulissa koulutettuna ja Euroopan parhaissa keittiöissä hiottuna hänen filosofiansa keskittyy yhteen vakaumukseen: ainutlaatuisimmat ateriat ovat niitä, jotka juurtuvat paikkaan ja muistoon.',
      bio2:
        'LIORAssa hän on koonnut ruokalistan, joka kunnioittaa Välimeren ruokaperinteen laajuutta — Levantin hiilellä maustetuista proteiineista Campanian rannikon puu-uunipizzoihin — jokainen valmistus jalostettuna kauden raaka-aineilla ja modernilla tekniikalla.',
      name: 'Kokki Mehmet Yilmaz',
      role: 'Keittiöpäällikkö & perustajajäsen, LIORA',
      accoladeExcellenceLabel: 'Kulinaarista huippuosaamista',
      accoladeExcellenceValue: '15+ vuotta',
      accoladeDishesLabel: 'Luotua annosta',
      accoladeDishesValue: '200+',
      accoladeGuestsLabel: 'Tyytyväistä asiakasta',
      accoladeGuestsValue: '50 000+',
